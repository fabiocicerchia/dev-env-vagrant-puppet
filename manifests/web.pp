...
class utils {
    ...
    exec { 'scm-breeze':
        ...
        onlyif  => '/bin/bash -c \'exit $(( $( ls /home/vagrant/.scm_breeze 2>&1 | wc -l ) == 0 ))\'',
        require => Package['git'],
    }
}
...
exec { 'php-cs-fixer':
    ...
    onlyif  => '/bin/bash -c \'exit $(( $( ls /usr/local/bin/php-cs-fixer 2>&1 | wc -l ) == 0 ))\'',
    require => Class['php'],
}
...
exec { 'composer':
    ...
    onlyif  => '/bin/bash -c \'exit $(( $( ls /usr/local/bin/composer 2>&1 | wc -l ) == 0 ))\'',
...
exec { 'behat':
    ...
    onlyif  => '/bin/bash -c \'exit $(( $( ls /usr/local/bin/behat 2>&1 | wc -l ) == 0 ))\'',
    require => Class['php'],
}
...
exec { 'pear install phpunit':
    ...
    onlyif  => '/bin/bash -c \'exit $(( $( ls /usr/bin/phpunit 2>&1 | wc -l ) == 0 ))\'',
...
exec { 'pear install phploc':
    ...
    onlyif  => '/bin/bash -c \'exit $(( $( ls /usr/bin/phploc 2>&1 | wc -l ) == 0 ))\'',
    require => Exec['pear update-channels']
}
...
exec { 'pear install phpcpd':
    ...
    onlyif  => '/bin/bash -c \'exit $(( $( ls /usr/bin/phpcpd 2>&1 | wc -l ) == 0 ))\'',
    require => Exec['pear update-channels']
}
...
exec { 'pear install phpdcd':
    ...
    onlyif  => '/bin/bash -c \'exit $(( $( ls /usr/bin/phpdcd 2>&1 | wc -l ) == 0 ))\'',
    require => Exec['pear update-channels']
}
...
exec { 'pear install phpcs':
    ...
    onlyif  => '/bin/bash -c \'exit $(( $( ls /usr/bin/phpcs 2>&1 | wc -l ) == 0 ))\'',
    require => Exec['pear update-channels']
}
...
exec { 'pear install pdepend':
    ...
    onlyif  => '/bin/bash -c \'exit $(( $( ls /usr/bin/pdepend 2>&1 | wc -l ) == 0 ))\'',
    require => Exec['pear update-channels']
}
...
exec { 'pear install phpmd':
    ...
    onlyif  => '/bin/bash -c \'exit $(( $( ls /usr/bin/phpmd 2>&1 | wc -l ) == 0 ))\'',
    require => Exec['pear update-channels']
}
...
exec { 'pear install PHP_CodeBrowser':
    ...
    onlyif  => '/bin/bash -c \'exit $(( $( ls /usr/bin/phpcb 2>&1 | wc -l ) == 0 ))\'',
    require => Exec['pear update-channels']
}
...
exec { 'pear install phpcov':
    ...
    onlyif  => '/bin/bash -c \'exit $(( $( ls /usr/bin/phpcov 2>&1 | wc -l ) == 0 ))\'',
    require => Exec['pear update-channels']
}
...
exec { 'pear install phpDocumentor':
    ...
    onlyif  => '/bin/bash -c \'exit $(( $( ls /usr/bin/phpdoc 2>&1 | wc -l ) == 0 ))\'',
    require => Exec['pear update-channels']
}
...
exec { 'pear install vfsStream':
    ...
    onlyif  => '/bin/bash -c \'exit $(( $( ls /usr/share/php/vfsStream 2>&1 | wc -l ) == 0 ))\'',
    require => Exec['pear update-channels']
}
